...
public class Rectangle extends Dessin {
	...
	if ( getArrondi() && plein )
	    g.fillRoundRect ( (int)a.getX(), (int)g.getClipBounds().getHeight()-((int)a.getY())-((int)getHauteur()), (int)getLargeur(), (int)getHauteur(), (int)arcLargeur, (int)arcHauteur );

	else if ( getArrondi() )
	    g.drawRoundRect ( (int)a.getX(), (int)g.getClipBounds().getHeight()-((int)a.getY())-((int)getHauteur()), (int)getLargeur(), (int)getHauteur(), (int)arcLargeur, (int)arcHauteur );

	else if ( plein )
	    g.fillRect ( (int)a.getX(), (int)g.getClipBounds().getHeight()-((int)a.getY())-((int)getHauteur()), (int)getLargeur(), (int)getHauteur() );

	else
	    g.drawRect ( (int)a.getX(), (int)g.getClipBounds().getHeight()-((int)a.getY())-((int)getHauteur()), (int)getLargeur(), (int)getHauteur() );
    }
